...
workout = input('Type in the workout name: ')

filename = input('Type in the filename: ')
print('')

if workout == 'training' or workout == 'Training' or workout == 't':
    workout = 'Training '
    for k in range(19, 27):
        workout = workout+filename[k]

with open('C:/Users/bguen/Documents/LiNK for Windows/Exported Files/'+filename+'.csv') as f:
    readCSV = csv.reader(f, delimiter=',')

    for row in range(0, 16):
        summary = next(readCSV)
...
path = 'C:/Users/bguen/Documents/LiNK for Windows/Exported Files/Auswertung/' + workout + '/'
...
newpath = r'C:/Users/bguen/Documents/LiNK for Windows/Exported Files/Auswertung/' + workout
...
plt.tight_layout()
plt.savefig('C:/Users/bguen/Documents/LiNK for Windows/Exported Files/Auswertung/'+workout+'/Split.pdf', format='PDF')
plt.draw()
plt.gcf().clear()
...
plt.gca().invert_yaxis()
plt.tight_layout()
plt.savefig('C:/Users/bguen/Documents/LiNK for Windows/Exported Files/Auswertung/'+workout+'/StrokeRate.pdf'
            , format='PDF')
plt.draw()
plt.gcf().clear()
...
if correct_HR_values == True:
    ...
    plt.gca().invert_yaxis()
    plt.tight_layout()
    plt.savefig('C:/Users/bguen/Documents/LiNK for Windows/Exported Files/Auswertung/'+workout+'/HeartRate.pdf'
                , format='PDF')
    plt.draw()
    plt.gcf().clear()
...
plt.legend()
plt.tight_layout()
plt.savefig('C:/Users/bguen/Documents/LiNK for Windows/Exported Files/Auswertung/'+workout+'/DPS.pdf', format='PDF')
plt.draw()
plt.gcf().clear()
